...
pub trait SerializePacket {
    ...
    fn write_string(self, buf: &mut impl Write, string: &String) -> usize {
    ...
    fn write_optional_string(self, buf: &mut impl Write, string: &Option<String>) -> usize {
        buf.write_i8(string.is_some() as i8)?;
